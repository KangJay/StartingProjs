...
application.secret_key = 'nwonvisnoininaffv21423'

s3 = boto3.resource('s3')
#IAM user credentials weren't working for DynamoDB
session = boto3.Session( 
    aws_access_key_id="AKIAJTSG64PLI6PXY6VQ",
    aws_secret_access_key="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",
...
#data_url = "https://s3-us-west-2.amazonaws.com/jikangprog4bucket/userDB.txt"
...
def create_table():
    try:
        ...
        for element in userDict:
            #record = ' '.join(element.split()).split() #each record is parsed by its attributes
